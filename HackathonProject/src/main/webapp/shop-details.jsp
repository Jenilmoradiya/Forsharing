      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 ml-auto mb-7 mb-lg-0">
           ...
           %>
                      <a href="AddToWishlist.jsp?pid=<%=p.getPid() %>&uid=<%=u.getUid()%>"class="btn btn-black rounded-0">Add To Wishlist</a>  
                  
                <%     }
                    else{
                    	  %>
                  	  <a href="RemoveFromWishlist.jsp?pid=<%=p.getPid()%>&uid=<%=u.getUid()%>" class="btn btn-black rounded-0 ">remove from wishlist</a>
